...
#a=10
#http://www.cplusplus.com/reference/cstdio/printf/7kw=printf
#print "Mainīgā a vertībā ir $a"
...
#print "Mainīgā a vērtība kā simbols skaitlis ir %c!"%(a)
print "Mainīgā a vērtība daļskaitlis ir %10.3f"%(a)
